(() => {
  ...
  // src/js/main.min.js
  var import_intersection_observer = __toESM(require_intersection_observer(), 1);
  var import_focus_visible = __toESM(require_focus_visible(), 1);
  var import_smooth_scroll = __toESM(require_smooth_scroll_polyfills_min(), 1);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const scroll2 = new import_smooth_scroll.default("js-smooth-scroll");
    onWindowResize(() => {
      calcViewportHeight();
    });
    calcViewportHeight();
